...
const AddBelanja = ({ idOutlet, fetchDataBelanja,  fetchDataKategori, fetchDataCard }) => {
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[820px] my-[20px] p-[25px]">
                <div className='flex justify-between'>
                    <DialogHeader>
                        <DialogTitle className='text-[18px] '>Tambah Belanja</DialogTitle>
                    </DialogHeader>
                    <DialogClose asChild>
